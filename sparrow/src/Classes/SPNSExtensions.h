...
/** Sparrow extensions for the UIImage class */
@interface UIImage (SPNSExtensions)

/// Returns a UIImage filled with perlin noise generated by the given instance and
/// interpolated between the two provided colors.
